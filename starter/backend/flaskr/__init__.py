...
def create_app(test_config=None):
  ...
  '''
    ...
    def after_request(response):
        ...
        response.headers.add('Access-Control-Allow-Mehods',
  ...
  '''
    ...
    def get_question_by_category(category_id):
        ...
        question_query = Question.query.filter_by(category=category_id).all()
  ...
  '''
    ...
    def get_quiz():
        if request.data:
            ...
            if (('quiz_category' in search_data and
                 'id' in search_data['quiz_category']) and
