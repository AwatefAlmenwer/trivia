...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with self.app.app_context():
            ...
            self.new_question = {
            'question': 'what is make you happy?',
            'answer': 'write a code',
            'difficulty': 1,
            'category': 1
           }
    ...
    def test_404_paginated_questions_beyond_valid_page(self):
    ...
    def test_404_search_questions_not_found(self):
        res = self.client().get('/questions?page=1000', json=self.search_term)
        data = json.loads(res.data)
    ...
    def test_422_search_questions_unprocessable(self):
    ...
    def test_404_get_quiz(self):
        res = self.client().post('/quizzes', json=self.quiz_error)
        data = json.loads(res.data)
